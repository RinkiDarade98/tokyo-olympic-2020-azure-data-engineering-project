...
In this project I have used Azure Data Factory to extract the data from data source (here data suorce is my github repository) and then load that raw data into Data Lake Gen 2 container.
